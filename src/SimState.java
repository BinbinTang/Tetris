...
public class SimState extends State{
	...
	public void setField(int[][] f){
		if(f.length!=field.length || f[0].length!=field[0].length){
			System.out.println("[SimState] field size different");
			return;
		}
	...
	public void setTop(int[] f){
		if(f.length!=top.length){
			System.out.println("[SimState] top size different");
			return;
		}
    ...
    public void setNextPiece(int nxt){
    	nextPiece= nxt;
    }
